        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  FadeInUp(duration: Duration(milliseconds: 1000), child:Text("Bienvenido", style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 30
                  ),)),
                  SizedBox(height: 20,),
                  FadeInUp(duration: Duration(milliseconds: 1200), child: Text("Inicia sesión si ya tienes una cuenta, si no, registrate para obtener una", 
                ...
                children: <Widget>[
                  ...
                  FadeInUp(duration: Duration(milliseconds: 1600), child: Container(
                    ...
                    child: MaterialButton(
                      ...
                      color: const Color.fromARGB(255, 88, 214, 140),
                      elevation: 0,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(50)
                      ),
